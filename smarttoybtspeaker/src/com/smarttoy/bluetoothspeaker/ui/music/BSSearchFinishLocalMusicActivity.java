...
public class BSSearchFinishLocalMusicActivity extends BSActionBarActivity implements OnTimer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bs_activity_music_search_finish_local);
